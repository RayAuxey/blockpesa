  ...
  _createClass(CallBuilder, [
        ...
        var createEventSource = function createEventSource() {
          ...
          es.onmessage = function(message) {
            var result = message.data
              ? _this2._parseRecord(JSON.parse(message.data))
              : message;
    ...
    },
    {
      ...
      value: function _sendNormalRequest(initialUrl) {
        ...
        return _horizon_axios_client2.default
          .get(url.toString())
    ...
    },
    {
      ...
      value: function _toCollectionPage(json) {
        ...
        for (var i = 0; i < json._embedded.records.length; i += 1) {
          // eslint-disable-next-line no-param-reassign
          json._embedded.records[i] = this._parseRecord(
            json._embedded.records[i]
          );
        }
        return {
          ...
          next: function next() {
            return _this5
              ._sendNormalRequest((0, _urijs2.default)(json._links.next.href))
              .then(function(r) {
          ...
          prev: function prev() {
            return _this5
              ._sendNormalRequest((0, _urijs2.default)(json._links.prev.href))
              .then(function(r) {
                return _this5._toCollectionPage(r);
              });
          }
